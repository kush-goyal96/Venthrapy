...
const Home = () => {
  return (
    <div className="relative text-primary font-inter-tight w-full bg-cover bg-center bg-no-repeat bg-[url('/src/assets/bacground.svg')] flex flex-col overflow-hidden">
      <div
        aria-hidden="true"
